...
public class CarAgent extends Agent {
    ...
    protected void setup() {
        System.out.println("CarAgent " + getAID().getName() + " is ready.");
    ...
    private class CarBehaviour extends CyclicBehaviour {
        public void action() {
            ...
            if (msg != null) {
                ...
                System.out.println("Car agent " + getAID().getName() + " received message: " + content);
                ...
                if (content.equals("MOVE_NORTH")) {
                    ...
                    msg.addReceiver(getCarAgentAID());
                    msg.setContent(Integer.toString(priority));
                    send(msg);
                    System.out.println("CarAgent " + getAID().getName() + " sent priority: " + priority);
                }
                block();
            }
        }
        ...
        private void moveNorth() {
            if (avenue > 1) {
                avenue--;
                System.out.println("CarAgent " + getAID().getName() + " moved north to position (" + avenue + ", " + street + ")");
                sharedObject.setAvenue(Integer.toString(avenue));
                sharedObject.setStreet(Integer.toString(street));
            } else {
                System.out.println("CarAgent " + getAID().getName() + " cannot move north. Already at the northernmost position.");
                sharedObject.setAvenue(Integer.toString(avenue));
                sharedObject.setStreet(Integer.toString(street));
            }
        }
        ...
        private void moveSouth() {
            if (avenue < max_avenue) {
                avenue++;
                System.out.println("CarAgent " + getAID().getName() + " moved south to position (" + avenue + ", " + street + ")");
                sharedObject.setAvenue(Integer.toString(avenue));
                sharedObject.setStreet(Integer.toString(street));               
            } else {
                System.out.println("CarAgent " + getAID().getName() + " cannot move south. Already at the southernmost position.");
                sharedObject.setAvenue(Integer.toString(avenue));
                sharedObject.setStreet(Integer.toString(street));
            }
        }
        ...
        private void moveWest() {
            if (street > 1) {
                street--;
                System.out.println("CarAgent " + getAID().getName() + " moved west to position (" + avenue + ", " + street + ")");
                sharedObject.setAvenue(Integer.toString(avenue));
                sharedObject.setStreet(Integer.toString(street)); 
            } else {
                System.out.println("CarAgent " + getAID().getName() + " cannot move west. Already at the westernmost position.");
                sharedObject.setAvenue(Integer.toString(avenue));
                sharedObject.setStreet(Integer.toString(street));
            }
        }
        ...
        private void moveEast() {
            if (street < max_street) {
                street++;
                System.out.println("CarAgent " + getAID().getName() + " moved east to position (" + avenue + ", " + street + ")");
                sharedObject.setAvenue(Integer.toString(avenue));
                sharedObject.setStreet(Integer.toString(street));           
            } else {
                System.out.println("CarAgent " + getAID().getName() + " cannot move east. Already at the easternmost position.");
                sharedObject.setAvenue(Integer.toString(avenue));
                sharedObject.setStreet(Integer.toString(street));
            }
        }
            ...
            if (isValidPosition(targetAvenue, targetStreet)) {
                ...
                if (shortestPath != null) {
                    ...
                    for (Position position : shortestPath) {
                        ...
                        System.out.println("CarAgent " + getAID().getName() + " moved to position (" + avenue + ", " + street + ")");
                    ...
                    System.out.println("CarAgent " + getAID().getName() + " could not find a path to position (" + targetAvenue + ", " + targetStreet + ")");
                    sharedObject.setAvenueList(Integer.toString(targetAvenue));
                    sharedObject.setStreetList(Integer.toString(targetStreet));
                }
            } else {
                System.out.println("CarAgent " + getAID().getName() + " cannot move to invalid position (" + targetAvenue + ", " + targetStreet + ")");
                sharedObject.setAvenueList(Integer.toString(targetAvenue));
                sharedObject.setStreetList(Integer.toString(targetStreet));
            }           
        }
        ...
        private AID getCarAgentAID() {
            // Specify the AID of the car agent
            return new AID("CarAgent", AID.ISLOCALNAME);
        } 
